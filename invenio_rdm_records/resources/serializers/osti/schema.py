# MSD-LIVE change: custom OSTI serializer used to convert the json format of an RDM record to the OSTI json schema
...
class AuthorSchema(Schema):
    ...
    # person_or_org.name is the name entered if Organization is chosen as an author, but OSTI requires a
    # first and last name. So if we don't have first and last name, use the org's full name as both
    ...
    # optionally is affiliation_name, private_email (N/A as RDM doesn't even ask for it?), orcid_id
